        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            BEGIN
                ...
                FROM (
                    ...
                    ORDER BY
                        CASE WHEN @SortBy = 'tenLoaiChungTu' AND LOWER(@SortType) = 'asc' THEN TenLoaiChungTu END ASC,
                        ...
                        CASE WHEN @SortBy = 'creationTime' AND LOWER(@SortType) = 'asc' THEN CreationTime END ASC,
                        CASE WHEN @SortBy = 'tenLoaiChungTu' AND LOWER(@SortType) = 'desc' THEN TenLoaiChungTu END DESC,
                        ...
                        CASE WHEN @SortBy = 'creationTime' AND LOWER(@SortType) = 'desc' THEN CreationTime END DESC
