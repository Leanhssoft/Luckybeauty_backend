...
{
    public class DMNganHangBuilder
    {
        private readonly SPADbContext _context;

        public DMNganHangBuilder(SPADbContext context)
        {
            _context = context;
        }
        public void  InitDMNganHang(int tenantId)
        {
            var cc = _context.DM_NganHang.Where(x=>x.TenantId == tenantId).Count();
            //if (!_context.DM_NganHang.Any(u => u.TenantId == tenantId))
            //{
