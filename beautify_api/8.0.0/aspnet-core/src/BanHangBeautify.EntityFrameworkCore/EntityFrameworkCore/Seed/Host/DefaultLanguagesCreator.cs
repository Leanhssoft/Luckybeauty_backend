...
namespace BanHangBeautify.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = SPAConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
            return new List<ApplicationLanguage>
            {
                ...
                new ApplicationLanguage(tenantId, "vi", "Việt Nam", "famfamfam-flags vi")
            };
        }

        public DefaultLanguagesCreator(SPADbContext context)
        {
            _context = context;
        }
