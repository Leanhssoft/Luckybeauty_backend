...
{
    public abstract class SPAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SPAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SPAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SPADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SPADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SPADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SPADbContext, Task<T>> func)
        {
            T result;
